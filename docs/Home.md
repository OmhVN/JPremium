...
- [Storage Configuration](#%EF%B8%8F-storage-configuration)
...
├── resolver/       — Mojang API integration (with retry backoff)
...
- [Cài đặt](#-cài-đặt)
- [Cấu hình lưu trữ](#%EF%B8%8F-cấu-hình-lưu-trữ)
- [Cấu trúc dự án](#%EF%B8%8F-cấu-trúc-dự-án)
- [Phụ thuộc chính](#-phụ-thuộc-chính)
- [Ghi công](#-ghi-công)
...
| ⚡ **Giới hạn tốc độ** | Chống tấn công brute-force với exponential backoff |
...
├── resolver/       — Tích hợp Mojang API (có retry backoff)
└── integration/    — PlaceholderAPI
```
