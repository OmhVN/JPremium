...
public class VelocityConfirmPasswordRecoveryCommand
extends AbstractVelocityPlayerCommand {
    public VelocityConfirmPasswordRecoveryCommand(JPremiumVelocity jPremiumVelocity) {
        super(jPremiumVelocity, "confirmPasswordRecovery");
    }
