...
public class VelocityChangeEmailAddressCommand
extends AbstractVelocityPlayerCommand {
    public VelocityChangeEmailAddressCommand(JPremiumVelocity jPremiumVelocity) {
        super(jPremiumVelocity, "changeEmailAddress");
    }
    ...
    public void executeForPlayer(Player player, UserProfileData userProfile, String[] arguments) {
        ...
        this.plugin.fireEventAsync(new UserEvent.ChangeEmailAddress(userProfile, (CommandSource)player));
    }
}
